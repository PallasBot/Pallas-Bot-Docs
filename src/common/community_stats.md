...
> **与共享语料无关**：在线统计默认开启；共享语料默认关闭，需单独在「语料联邦」中开启（见 [语料联邦](/common/corpus)）。
...
开启名册公开后，会上传名册内牛的 QQ、昵称、在线状态与近 7 日消息量权重；社区主站气泡墙会展示 QQ 并提供资料卡链接，便于加好友。

## 相关文档

- [语料联邦](/common/corpus)（共享接话池，默认关闭）
