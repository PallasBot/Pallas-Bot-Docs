...
::: tip 导航
[配置存储](/developer/architecture/config-storage) · [标准部署](/deploy/deployment) · [Docker 部署](/deploy/docker) · [FAQ](/deploy/faq)
:::
...
| 合并顺序与热重载 | [配置存储](/developer/architecture/config-storage) |
| 站点插件与扩展 | [站点定制](/maintainer/deploy/upgrade) |
