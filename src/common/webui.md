...
可参考 [`src/plugins/draw/config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/draw/config.py)。
...
可参考 [`src/plugins/draw/config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/draw/config.py) 中的 `on_draw_config_reload`。
