...
实现位于 [`src/common/message_scrub/`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/common/message_scrub/)；配置模型见 [`config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/common/message_scrub/config.py)。其它插件若要复用同一套判断，可：
