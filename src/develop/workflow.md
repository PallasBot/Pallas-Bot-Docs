...
- **4.0 / 瘦身 / 牛格**：见 [4.0 路线图](../architecture/pallas-4.0-roadmap.md)、[本体瘦身](../architecture/pallas-4.0-slim.md)
...
| **4.0** | [4.0 路线图](../architecture/pallas-4.0-roadmap.md)、[本体瘦身](../architecture/pallas-4.0-slim.md) |
