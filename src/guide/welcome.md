...
不用一次读完。牛也是一步一步醒的：先让进程起来，再连 QQ，玩法与 AI 以后再加也不迟。
...
| 我想… | 打开 |
| --- | --- |
| 最快跑起来 | [quickstart](/guide/quickstart) |
| 连 QQ | [connect-qq](connect-qq.md) |
| 装扩展 | [install-extensions](install-extensions.md) |
| 用网页改配置 | [web-console](web-console.md) |
| 群里有哪些口令 | [usage](usage.md) |
| 进阶 / 排错 | [advanced](advanced.md) · [FAQ](/deploy/faq) · [排障](/maintainer/operate/troubleshooting) |
| 写插件 | [插件开发入门](/developer/plugin-development/getting-started) |
