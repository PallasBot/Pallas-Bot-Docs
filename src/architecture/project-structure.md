...
- `scripts/`: 运维脚本（索引见 [scripts/README.md](https://github.com/PallasBot/Pallas-Bot/tree/main/scripts/README.md)）
...
- `resource/arknights/`：明日方舟干员表与头像（决斗 / 未来 KB 共用，见 [arknights-knowledge-mcp](/architecture/arknights-knowledge-mcp)）。
