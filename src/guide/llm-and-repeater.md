...
总闸仍是 **`LLM_CHAT_ENABLED`**。开关总览：[把玩法 / AI 也装上](/guide/4.0-start)。
...
- [`@牛牛` 怎么用](/plugins/llm_chat)
- [平时接话 / 复读](/plugins/repeater)
- [牛格和群味](/plugins/persona)
- [开关总览](/guide/4.0-start)
