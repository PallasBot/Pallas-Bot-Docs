...
WebUI **插件 → 牛牛卧底** 或 [`config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/who_is_spy/config.py)。常用项：最少/最多人数、默认卧底与白板数、是否暗牌、述词字数上限等。
...
[`src/plugins/who_is_spy/`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/who_is_spy/)
