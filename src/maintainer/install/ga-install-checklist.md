...
**相关文档**：[Docker 部署](../../DockerDeployment.md) · [AI Runtime](ai-runtime.md) · [运维入口](/maintainer/quickstart) · [升级](/maintainer/deploy/upgrade)
...
- [ ] 打开 `http://<宿主机>:8088/pallas/protocol`，能创建/管理协议端实例
- [ ] QQ 连上后群内 **牛牛帮助** 有响应
