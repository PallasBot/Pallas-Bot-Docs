...
[`config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/greeting/config.py)（如 `enable_kick_ban`）。素材与持久化目录 **`data/greeting/`**；语音资源 **`resource/voices/`**。
...
[`src/plugins/greeting/`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/greeting/)
