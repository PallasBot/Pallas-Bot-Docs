...
管理员安装说明：[社区插件商店](community-plugin-store.md)。插件结构：[Golden Plugin](/developer/plugin-development/golden-plugin)。
...
包内路径规则：[插件目录约定 · 包内视觉资源](/architecture/plugin-convention#插件包内视觉资源assets)。
