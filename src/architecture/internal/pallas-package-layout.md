...
> **关系**：[Pallas 核心契约](pallas-core-contract.md)（产品与边界）· [开发者架构总览](/developer/architecture/overview)（现行入口）· [内核插件统一化](core-plugin-unification-design.md)（golden 模板）
...
- **主仓 `pallas/core|console|product`**：按现行内核边界依赖；对外入口优先收敛到 `pallas.api.*`。
...
Cookbook：[pallas-api-cookbook.md](/developer/plugin-development/pallas-api-cookbook)。
...
| 文件 | 当前状态 | 需改为 |
| --- | --- | --- |
| `docs/developer/plugin-development/getting-started.md` | 现行插件开发入口 | `packages/`、`pallas.api.commands`、`pallas.api.config`、`pallas.api.perm` |
| `docs/developer/plugin-development/golden-plugin.md` | 现行插件骨架约定 | `pallas.api.*` |
| `docs/developer/plugin-development/config-and-webui.md` | 现行配置与 WebUI 入口 | `pallas.api.*` |
| `docs/developer/plugin-development/testing.md` | 现行测试入口 | `tests/plugins/*` |
...
- [x] 4.x → 4.0 layout migration 段落写入 [FAQ](/deploy/faq)（§9 P7+）→ [FAQ §4.0 布局与迁移](/deploy/faq#faq-40-layout)
...
| [developer/plugin-development/getting-started.md](/developer/plugin-development/getting-started) | 现行插件开发入口 | ✅ 已建立 |
| [developer/plugin-development/golden-plugin.md](/developer/plugin-development/golden-plugin) | 现行插件骨架说明 | ✅ 已建立 |
| [developer/plugin-development/config-and-webui.md](/developer/plugin-development/config-and-webui) | 现行配置入口 | ✅ 已建立 |
| [developer/plugin-development/testing.md](/developer/plugin-development/testing) | 现行测试入口 | ✅ 已建立 |
| [skills/pallas-plugin-development/SKILL.md](https://github.com/PallasBot/Pallas-Bot/blob/main/docs/skills/pallas-plugin-development/SKILL.md) | 关键概念 + 插件位置 | ✅ 已更新 |
| [skills/pallas-plugin-development/references/01-05,08](https://github.com/PallasBot/Pallas-Bot/blob/main/docs/skills/pallas-plugin-development/SKILL.md) | 全部 reference 改用 `pallas.api.*` | ✅ 已更新 |
...
| [pallas-api-cookbook.md](/developer/plugin-development/pallas-api-cookbook) | 扩展作者 api 入口 | ✅ 已建立 |
