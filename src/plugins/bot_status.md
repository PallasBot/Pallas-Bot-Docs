...
[`config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/bot_status/config.py)：`bot_status_smtp_*`、`bot_status_notice_email`、`bot_status_offline_grace_time`、`bot_status_list_mode`。
...
[`src/plugins/bot_status/`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/bot_status/)
