...
| 启用 | **4.0 默认开启**；WebUI「通用配置 → 消息审查」可直接配词表或 API。设 `PALLAS_MESSAGE_SCRUB_ENABLED=false` 可完全关闭 |
...
完整字段见 WebUI 或 [`config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/features/message_scrub/config.py)。
...
[`src/features/message_scrub/`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/features/message_scrub/)
