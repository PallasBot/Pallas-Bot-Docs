...
> 配合 [hot-reload-tiers.md](/architecture/hot-reload-tiers) 与官方扩展 `activation_policy`。WebUI 保存插件配置或执行 `POST /plugins/{name}/reload` 前，维护者按本清单自检。
...
- [hot-reload-tiers.md](/architecture/hot-reload-tiers)
- [core-plugin-unification-design.md](/architecture/internal/core-plugin-unification-design)
