...
[`config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/chat/config.py) 中 `ai_server_host` 等已弃用，请在 WebUI **环境变量** 或 `pallas.toml` `[env]` 配置 `AI_SERVER_*` 与 `LLM_CHAT_ENABLED`。
