...
| 你发 | 需要 |
| --- | --- |
| `牛牛唱歌` / 点歌 | [Pallas-Bot-AI](https://github.com/PallasBot/Pallas-Bot-AI) + 扩展 |
| `牛牛画画` | 同上 + draw |
| 随时 @ 闲聊 | 控制台打开 LLM；见 [AI 扩展](ai.md) |

可先发 `牛牛连通` 测 Bot 能不能连上 AI。
...
▶ [插件手册](/plugins/index) · [使用指南](/guide/usage-admin)
