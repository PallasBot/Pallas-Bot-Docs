...
::: tip 先跑起来再折腾
第一次装：单进程即可。消息怎么进牛肚子、要不要装扩展，可先瞄一眼 [4.0 启动说明](/guide/4.0-start) 里的两张图。卡住了去 [排障](/maintainer/operate/troubleshooting)。
:::
...
安装验收走查见 **[4.0 安装验收 Checklist](/maintainer/install/ga-install-checklist)**（从 0 新装 / 升级 / 全栈 Docker）。
...
- [LLM 与 AI](/maintainer/operate/llm-and-ai)（闲聊 / 记忆链路）
