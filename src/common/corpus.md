...
架构细节见 [控制面与语料联邦](/architecture/control-plane-corpus-federation)（维护者向）。中心服务见 [Pallas-Bot-Community-Stats](https://github.com/TogetsuDo/Pallas-Bot-Community-Stats)。
