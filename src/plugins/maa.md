...
完整键见 [`config.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/maa/config.py)。
...
[`src/plugins/maa/`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/plugins/maa/)
