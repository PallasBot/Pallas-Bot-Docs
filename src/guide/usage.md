...
| `牛牛喝酒` / `醒一醒` | 喝酒玩法 |
| `牛牛轮盘` | 轮盘；`牛牛救一下` / `牛牛补一枪` |
| 复读相关 | 学习群友说话后接话（见 [repeater](/plugins/repeater)） |
...
| 你发 | 要先装 |
| --- | --- |
| 决斗、八角笼 | `pallas-plugin-duel` → [决斗](/plugins/duel) |
| 谁是卧底 | `pallas-plugin-who-is-spy` |
| `牛牛做梦` | `pallas-plugin-dream` |
| MAA 远控口令 | `pallas-plugin-maa` → [maa](/plugins/maa) |
...
▶ [插件手册](/plugins/index) · [使用指南（管理员）](/guide/usage-admin)
