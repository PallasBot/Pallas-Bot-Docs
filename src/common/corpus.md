...
查找顺序默认**先本机再共享池**；远端失败自动退回本机。架构见 [控制面与语料联邦](/architecture/control-plane-corpus-federation)。
...
[`src/features/corpus/`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/features/corpus/) · 中心服务 [Community-Stats](https://github.com/TogetsuDo/Pallas-Bot-Community-Stats)
