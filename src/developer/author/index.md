...
5. [发布](/developer/plugin-development/publishing)
...
1. [架构总览](/developer/architecture/overview)
2. [分片运行时](/developer/architecture/shard-runtime)
3. [插件治理与分层](/developer/architecture/plugin-governance)
4. [仓库结构](/developer/reference/repo-layout)

### 如果你是官方扩展作者

建议顺序：

1. [Core 与扩展](/developer/architecture/core-vs-extensions)
2. [Golden Plugin](/developer/plugin-development/golden-plugin)
3. [元数据](/developer/plugin-development/metadata)
4. [发布](/developer/plugin-development/publishing)

### 如果你是社区插件作者

建议顺序：

1. [插件开发入门](/developer/plugin-development/getting-started)
2. [配置与 WebUI](/developer/plugin-development/config-and-webui)
3. [Platform API](/developer/reference/platform-api)
4. [Internal API](/developer/reference/internal-api)

## 相关阅读

- [Developer](/developer/index)
- [仓库结构](/developer/reference/repo-layout)
- [写作与风格约定](/developer/reference/style-guide)
