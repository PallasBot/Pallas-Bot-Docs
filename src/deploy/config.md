...
- [配置存储](/architecture/settings-storage) — 合并顺序、热重载
- [标准部署](/deploy/deployment) — 分步安装与验证
- [Docker 部署](/deploy/docker) — Compose 与卷挂载
- [站点定制与更新](/architecture/site-customization-and-updates) — `local/plugins` 与更新策略
