...
Pallas 4.0 开发者契约入口。维护者部署见 [`docs/maintainer/`](/maintainer/quickstart)。深度设计稿见 [`docs/architecture/`](../architecture/)（非主入口）。
...
| [reference/](/developer/reference/repo-layout) | 仓库布局、API 分层、控制台约定、文风 |
