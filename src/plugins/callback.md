...
> **4.0 起已收进内核**：HTTP 路由与执行分别在 [`platform/ai_callback/http.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/platform/ai_callback/http.py) 与 [`runner.py`](https://github.com/PallasBot/Pallas-Bot/tree/main/src/platform/ai_callback/runner.py)。本目录插件已移除。
